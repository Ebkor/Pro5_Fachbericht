...
Die Beleuchtung des \textsc{Detroit}s soll gemäss Auftraggeber zweckmässig sein und dem modernen Sicherheitsstandard entsprechen.
...
\item Meterlicht (Beleuchtung des Volt- und Ampèremeters)
...
Die beiden Dioden $D_1$ und $D_2$ sind dafür zuständig, dass bei der Betätigung einer Blinkerrichtung zusätzlich nur die Kontrolllampe und nicht beide Blinker zu leuchten beginnen. Ebenfalls ist parallel zur Kontrolllampe ein Summer installiert, damit der Fahrer nach dem Abbiegen daran erinnert wird, dass er den Blinker wieder ausschalten sollte.
...
Dieser Endschalter ist bei nicht betätigter Bremse, so wie es in der Abbildung \ref{fig:EndschalterBremslicht} ersichtlich ist, offen und schliesst sich erst, wenn die Bremse betätigt wird. Auch wenn das Rücklicht ausgeschaltet ist, funktioniert das Bremslicht noch immer.
