...
Die beiden Dioden $D_1$ und $D_2$ sind dafür zuständig, dass bei der Betätigung einer Blinkerrichtung zusätzlich nur die Kontrolllampe leuchtet und nicht beide Blinker beginnen zu schalten. Ebenfalls ist parallel zur Kontrolllampe ein Summer installiert, damit der Fahrer nach dem Abbiegen daran erinnert wird, dass er den Blinker wieder ausschalten sollte.
