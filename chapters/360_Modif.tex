...
Daraus resultieren einige Anforderungen an den Shunt bzw. das Material, aus welchem er gefertigt ist: \begin{itemize}
	...
	\item Die Genauigkeit muss nicht besonders hoch sein, da das Ablesen an einem analogen Instrument erfolgt und nur einen Richtwert liefern soll. Auch eine nicht allzu grosse Nichtlinearität bei Temperaturänderung ist tolerierbar.
\end{itemize}
