...
\textcolor{blue}{Nachfolgend sind die Parameter, welche im BMS eingestellt werden können, aufgelistet. Ist dahinter ein zweiter Eintrag in \textit{kursiv}, so wurde dieser Wert nach}
